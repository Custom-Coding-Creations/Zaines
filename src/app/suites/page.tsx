...
const suiteMetadata: Record<string, {
  ...
  "Standard Suite": {
    ...
    icon: Home,
    features: [
      "Comfortable bed with clean, washable bedding",
      "Climate controlled environment",
      "Daily cleaning and suite maintenance",
      "2 supervised potty breaks",
      "2 group play sessions",
      "Meal service (2x daily)",
      "Enrichment toys available",
    ],
  ...
  "Luxury Suite": {
    ...
    icon: Crown,
    features: [
      "Private outdoor area with shade",
      "Premium comfortable bedding",
      "Climate controlled environment",
      "Regular updates and direct communication",
      "4 supervised potty breaks + flexible access",
      "4 customized play sessions",
      "Meal service (custom schedule, premium options)",
      "Enrichment activities and entertainment",
      "Daily updates and photo sharing",
      "Evening care and bedtime routine",
...
const amenities = [
  {
    icon: Camera,
    title: "Peace of Mind",
    description: "Stay connected and up to date on how your pup is doing",
  },
  {
    icon: Wifi,
    title: "Comfortable Environment",
    description: "Suites are kept clean, comfortable, and well-maintained",
  },
  {
    icon: Thermometer,
    title: "Climate Control",
    description: "Temperature-regulated spaces for year-round comfort",
  },
  {
    icon: Music,
    title: "Calm Atmosphere",
    description: "A quiet, low-stress environment designed for relaxation",
  },
  {
    icon: Bed,
    title: "Cozy Bedding",
    description: "Clean, comfortable bedding that's regularly washed and refreshed",
  },
  {
    icon: Tv,
    title: "Enrichment Activities",
    description: "Engaging activities and stimulation tailored to your dog (Deluxe+)",
  },
];
