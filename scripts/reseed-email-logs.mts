...
const emails: Array<{
  ...
  // photo_digest — uses React Email render (representative equivalent with real img tags)
  {
    ...
    html: `<div style="${BASE}">
      ...
      <p style="${MUTED};margin-top:0;">Here are today's photos from Buddy's stay — Jun 22, 2026.</p>
      <table style="width:100%;border-collapse:collapse;margin:16px 0;">
        <tr>
          <td style="padding:4px;width:33.3%;">
            ...
            <p style="margin:6px 0 0;font-size:13px;${MUTED};text-align:center;">Morning playtime</p>
          </td>
          <td style="padding:4px;width:33.3%;">
            ...
            <p style="margin:6px 0 0;font-size:13px;${MUTED};text-align:center;">Afternoon nap</p>
          </td>
          <td style="padding:4px;width:33.3%;">
            ...
            <p style="margin:6px 0 0;font-size:13px;${MUTED};text-align:center;">Evening walk</p>
          </td>
        </tr>
      </table>
      <p style="text-align:center;margin:24px 0;"><a href="#" style="${BTN};padding:10px 20px;font-weight:600;">View All Photos in Dashboard</a></p>
      <p style="font-size:13px;${MUTED};text-align:center;">3 photos · Zaine's Stay &amp; Play · Jun 22, 2026</p>
    </div>`,
  },
];
